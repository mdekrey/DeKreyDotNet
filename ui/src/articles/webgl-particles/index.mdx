...
import image from '@/3d/explosion-screenshot.png';
export { image };
...
If you're interested in the source code... <SourceLink isTree={true} path="ui/src/3d">here you go!</SourceLink>
