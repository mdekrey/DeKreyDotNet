...
<figure>
	...
	<FigCaption>
		The View can access Model components, the Controller orchestrates both the
		View and the Model, and the Model remains pure.
	</FigCaption>
</figure>
...
<figure>
	...
	<FigCaption>
		The Presenter orchestrates both the View and the Model, and both the Model
		and the View remain separate from the other.
	</FigCaption>
</figure>
...
<figure>
	...
	<FigCaption>
		The View accesses the View-Model, the View-Model accesses the Model, and the
		Model remains pure.
	</FigCaption>
</figure>
