...
_**Note:** This is a repost of my Engineering Culture: Interviews article from
when I was Principle Architect at Principle Studios. My process has changed
(there is always room to learn!) a bit, but the core concepts will remain the
same._
...
I started asking questions… I realized that someone had to solve the problem at
some point in the history of the team, and they’d been using it as an interview
question ever since.
...
- Be aligned with our company cultural values
...
able to focus on just one of these qualities, and it’d be easy to find a
software engineer or manager to interview for each aspect.
...
making process), allow for plenty of time in the interview for candidates to ask
us about Principle and our work (usually at the front and after the main parts),
and try to make the interviews as conversational as possible.
...
inspiring and interesting ideas. Why can’t that be part of the interview process
too?
...
Our first interview always addresses our core cultural values. Presently, one of
our executive board members runs this interview, making sure everyone’s
expectations match, including what internal culture is like and how that blends
with the expectations from our clients.

## Skilled For Today

To see if a candidate has the skills we’re looking for currently, we invite them
to share code they’re passionate about that they’ve written! We ask them to walk
one of us through it, allowing us to ask questions and dive into the parts
they’re most excited about. Seeing another developer get excited is infectious
for our team, and gets us to see the candidate at their best: worries tend to
wash away and we all have a great time, knowing exactly how someone can fit into
our existing team.
