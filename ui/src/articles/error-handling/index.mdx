...
<figure>
	...
	<FigCaption>
		How many of us like using CLI tools for more than simple scripting via Perl
		or Powershell? (Image from Ferris Bueller's Day Off.)
	</FigCaption>
</figure>
...
<figure>
	...
	<FigCaption>
		No, I'm not suggesting checking out some pottery. (
		<a href="https://commons.wikimedia.org/wiki/File:Selection_of_Undecorated_Newcomb_College_Pieces.jpg">
			Image thanks to Wikipedia user Txhorns79
		</a>
		.)
	</FigCaption>
</figure>
