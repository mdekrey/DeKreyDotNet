...
import ogImage from './games-architecture.png';
export { ogImage };
...
<FigCaption>Source code in C# and TypeScript/React, deployed to Azure Functions and Azure Kubernetes Service.</FigCaption>
</figure>
