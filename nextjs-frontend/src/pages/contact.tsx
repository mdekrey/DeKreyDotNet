...
const ContactPage = ({ recaptchaSSR }: { recaptchaSSR?: Promise<ReCaptchaInstance> }) => {
	...
	}, [form, recaptchaInput, recaptchaPromise, router]);
	...
	return (
		<Layout>
			...
			<section className="text-gray-700">
				...
				<form
					action="https://contact-dekrey.azurewebsites.net/api/ContactMatt?"
					ref={form}
					onSubmit={submitForm}
					method="post"
					className="lg:w-1/2 md:w-2/3 mx-auto pb-8 border-b border-gray-200">
